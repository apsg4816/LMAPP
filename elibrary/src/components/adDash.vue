...
const url1 = "http://127.0.0.1:10000/admin_section";
const url2 = "http://127.0.0.1:10000/admin_book";
const url3 = "http://127.0.0.1:10000/section_book_search";
...
const fetchData = () => {
  ...
  axiosInstance.get('http://127.0.0.1:10000/admin_section')
    .then(response => {
  ...
  axiosInstance.get('http://127.0.0.1:10000/admin_book')
    .then(response => {
